...
from bin_cp.experiments.image_utils.image_datasets import get_normalize_layer
...
def get_architecture(arch: str, dataset: str) -> torch.nn.Module:
    ...
    if arch == "resnet50" and dataset == "imagenet":
        ...
        model = resnet(depth=20, num_classes=10).cuda()
    elif arch == "cifar_resnet110":
        model = resnet(depth=110, num_classes=10).cuda()
